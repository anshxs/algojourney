      ...
      <div className="flex min-w-0 flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex min-w-0 flex-col gap-4 sm:flex-row sm:items-center">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-3 flex flex-wrap gap-2 break-words text-sm text-zinc-400">
            ...
            {profile.aboutMe ? <p className="mt-3 max-w-2xl break-words text-sm text-zinc-300">{profile.aboutMe}</p> : null}
          </div>
        </div>
